									...
									<form method="post" action="<?php echo base_url(); ?>pages/login">
										...
										<div class="row">
											<div class="col-md-12">
												...
												<div class="form-wrap">
													<input type="password" name="user_password" value="" size="40" class="form-text highlighted" />
												</div>
												<div class="mb-2"></div>
											</div>
										</div>
										...
										<div class="row">
											<div class="col-md-12">
												<a href="<?php echo base_url(); ?>pages/rememberpass/rememberpass" class="mt-3 color fw-600">Lost your password?</a>
											</div>
										</div>
									</form>
								</div>
