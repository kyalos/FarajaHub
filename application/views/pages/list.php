						...
						<div class="row">
							<div class="col-md-12">
								<div class="section-title text-center">
									<h2 class="lato mb-1">Untold Stories</h2>
							...
							<div class="col-md-4">
								<div class="blog-item text-center mb-6">
									<div class="blog-inner">
										...
										<div class="info">
											<div class="tags">
												<a href="#">Free Your Mind</a>, <a href="<?php echo base_url(); ?>posts/category_posts/<?php echo $row->category_id; ?>"><?php echo $row->category; ?></a>
											</div>
											<div class="title">
