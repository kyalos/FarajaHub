						...
						<div class="row">
							<div class="col-md-12">
								<div class="section-title text-center">
									<h2 class="lato mb-1">Free Your Mind</h2>
								...
								<div class="blog-item text-center mb-6">
									<div class="blog-inner">
										...
										<div class="meta">
											...
											<span class="author">Posted by <a href="#"><?php echo $row->author; ?></a></span>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="col-md-12 p-0">
								...
								<ul class="instagram">
									<li class="col-sm-2 p-0">
										<a href="../../../../external.html?link=http://instagram.com/p/BLHutObDnHM" target="_blank">
									...
									<li class="col-sm-2 p-0">
										<a href="../../../../external.html?link=http://instagram.com/p/BLEc533j7yF" target="_blank">
											<div class="instagram-wrap">
												<div class="overlay"></div>
												<i class="fa fa-instagram"></i>
									...
									<li class="col-sm-2 p-0">
										<a href="../../../../external.html?link=http://instagram.com/p/BLByAeDjw_D" target="_blank">
											<div class="instagram-wrap">
												<div class="overlay"></div>
												<i class="fa fa-instagram"></i>
									...
									<li class="col-sm-2 p-0">
										<a href="../../../../external.html?link=http://instagram.com/p/BK_qGkyDEmd" target="_blank">
											<div class="instagram-wrap">
												<div class="overlay"></div>
												<i class="fa fa-instagram"></i>
									...
									<li class="col-sm-2 p-0">
										<a href="../../../../external.html?link=http://instagram.com/p/BK9CCUYDixS" target="_blank">
											<div class="instagram-wrap">
												<div class="overlay"></div>
												<i class="fa fa-instagram"></i>
									...
									<li class="col-sm-2 p-0">
										<a href="../../../../external.html?link=http://instagram.com/p/BK6E7dBDOLS" target="_blank">
											<div class="instagram-wrap">
												<div class="overlay"></div>
												<i class="fa fa-instagram"></i>
									...
									<li class="col-sm-2 p-0">
										<a href="../../../../external.html?link=http://instagram.com/p/BK4RhabDAaj" target="_blank">
											<div class="instagram-wrap">
												<div class="overlay"></div>
												<i class="fa fa-instagram"></i>
									...
									<li class="col-sm-2 p-0">
										<a href="../../../../external.html?link=http://instagram.com/p/BK2EzFaD_b7" target="_blank">
											<div class="instagram-wrap">
												<div class="overlay"></div>
												<i class="fa fa-instagram"></i>
									...
									<li class="col-sm-2 p-0">
										<a href="../../../../external.html?link=http://instagram.com/p/BK1YJEwjoKN" target="_blank">
											<div class="instagram-wrap">
												<div class="overlay"></div>
												<i class="fa fa-instagram"></i>
									...
									<li class="col-sm-2 p-0">
										<a href="../../../../external.html?link=http://instagram.com/p/BKzLuggjXH7" target="_blank">
											<div class="instagram-wrap">
												<div class="overlay"></div>
												<i class="fa fa-instagram"></i>
									...
									<li class="col-sm-2 p-0">
										<a href="../../../../external.html?link=http://instagram.com/p/BKvkxaeDUZN" target="_blank">
											<div class="instagram-wrap">
												<div class="overlay"></div>
												<i class="fa fa-instagram"></i>
									...
									<li class="col-sm-2 p-0">
										<a href="../../../../external.html?link=http://instagram.com/p/BKuN2fYjY6Q" target="_blank">
											<div class="instagram-wrap">
												<div class="overlay"></div>
												<i class="fa fa-instagram"></i>
			...
			<header class="header header-desktop">
				<div class="container-fluid">
					...
					<div class="row">
						...
						<li><a href="<?php echo base_url();?>pages/logout">logout</a></li>  
						  <li><a href="<?php echo base_url();?>posts/write">Write Something</a></li>
						  <li><a href="<?php echo base_url(); ?>pages/logout">Logout</a></li>
					</ul>
								</div>
							</div>
