								...
								<div class="blog-slick-slider" data-items="3">
									...
									<div class="blog-item">
										<div class="blog-inner">
											...
											<div class="info">
												<div class="tags">
													<a href="#">Free Your Mind</a>, <a href="<?php echo base_url(); ?>posts/category_posts/<?php echo $row->category; ?>"><?php echo $row->category; ?></a>
												</div>
												<div class="title">
					...
					<div class="container">
						<div class="row">
							<div class="col-md-4">
								<div class="banner">
									<a href="#" class="link">
										<img src="<?php echo base_url(); ?>assets/images/banner/banner_1.jpg" alt="" />
									</a>
									<div class="caption">
										<span>ABOUT ME</span>
									</div>
							...
							<div class="col-md-4">
								<div class="banner">
									<a href="#" class="link">
										<img src="<?php echo base_url(); ?>assets/images/banner/banner_2.jpg" alt="" />
									</a>
									<div class="caption">
										<span>LIFESTYLE</span>
									</div>
							...
							<div class="col-md-4">
								<div class="banner">
									<a href="#" class="link">
										<img src="<?php echo base_url(); ?>assets/images/banner/banner_3.jpg" alt="" />
									</a>
									<div class="caption">
