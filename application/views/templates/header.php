...
<head>
		...
		<link rel="shortcut icon" href="<?php echo base_url(); ?>assets/images/heart-pink.ico"/>
		<title>Shout &#8211; Blog Split | Shout Blog, Magazine &amp; Lifestyle HTML Template</title>
        <script src="https://use.fontawesome.com/86dff6f9aa.js"></script>
		...
		<link rel="stylesheet" href="<?php base_url(); ?>assets/css/font-materialdesign.css" type="text/css" media="all" />
		<link rel="stylesheet" href="<?php base_url(); ?>assets/css/slick.css" type="text/css" media="all" />
		<link rel="stylesheet" href="<?php base_url(); ?>assets/css/magnific-popup.min.css" type="text/css" media="all" />
		<link rel="stylesheet" href="<?php base_url(); ?>assets/css/flexslider.css" type="text/css" media="all" />
		<link rel="stylesheet" href="<?php base_url(); ?>assets/css/style.css" type="text/css" media="all" />
		<link rel="stylesheet" href="<?php base_url(); ?>assets/css/style-lifestyle.css" type="text/css" media="all" />
		<link rel="stylesheet" href="<?php base_url(); ?>assets/css/custom.css" type="text/css" media="all" />
		<link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/writepage.css">
		<link rel="stylesheet" href="http://fonts.googleapis.com/css?family=Lato:100,300,400,400i,700%7CSource+Sans+Pro:300,400,400i,600,700" />
